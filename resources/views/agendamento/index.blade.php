    ...
    <script defer>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getSelecionados() {
                let ids = [];
                document.querySelectorAll('.selecionar-agendamento:checked')
                    .forEach(cb => {
            ...
            document.querySelectorAll('.btn-excluir').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    let idsSelecionados = getSelecionados();
                    let idIndividual = this.getAttribute('data-id');

                    let ids = idsSelecionados.length > 0 ? idsSelecionados : [idIndividual];
                    ...
                    fetch('{{ route('agendamento.excluir') }}', {
                        ...
                        .then(data => {
                            if (data.success) {
                                alert('Agendamento(s) excluído(s)!');
                                location.reload();
                            } else {
            ...
            document.querySelectorAll('.btn-aceitar').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (!confirm('Deseja aceitar?')) return;
            ...
            document.querySelectorAll('.btn-recusar').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (!confirm('Deseja recusar?')) return;
                    ...
                    fetch('{{ route('agendamento.recusar') }}', {
                        ...
                        .then(data => {
                            if (data.success) {
                                alert('Agendamento(s) recusado(s)!');
                                location.reload();
                            } else {
